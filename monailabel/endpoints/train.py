...
@router.get("/", summary="Get Status of Training Task", dependencies=[Depends(validate_token)])
...
@router.post("/", summary="Run All Training Tasks", deprecated=True, dependencies=[Depends(validate_token)])
async def api_run(
...
@router.post("/{model}", summary="Run Training Task for specific model", dependencies=[Depends(validate_token)])
...
@router.delete("/", summary="Stop Training Task", dependencies=[Depends(validate_token)])
